CREATE TABLE EXERCISE(ISTEMPLATE BOOLEAN, #is this an exercise template?
...
CREATE TABLE LOGENTRY(WORKOUTID INT NOT NULL,
						...
						FOREIGN KEY (EXERCISENAME) REFERENCES EXERCISE(ID)
						ON DELETE CASCADE #Delete if exercise is deleted
						);
...
CREATE TABLE CANREPLACE(EXERCISENAMEA VARCHAR(255) NOT NULL, #Relation: two exercises are similar
						...
						FOREIGN KEY (EXERCISENAMEA) REFERENCES EXERCISE(ID),
						FOREIGN KEY (EXERCISENAMEB) REFERENCES EXERCISE(ID)
						);
